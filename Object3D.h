...
private:
    ...
    enum drawingInstances{outer_inner_points, outer_face, inner_face, outer_face_normal, integrator_line};
    
    int getOffset(drawingInstances instance);
    int getCount(drawingInstances instance);
